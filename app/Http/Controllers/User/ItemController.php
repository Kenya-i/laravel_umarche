...
class ItemController extends Controller
{
    ...
    public function index()
    {
        ...
        $products = DB::table('products')->joinSub($stocks, 'stock', function ($join) {
            ...
            ->select('products.id', 'products.name as name', 'products.price', 'products.sort_order as sort_order', 'products.information', 'secondary_categories.name as category', 'image1.filename as filename')
            ->get();
